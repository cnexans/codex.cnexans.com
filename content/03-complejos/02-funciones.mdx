...
<Definition title="Función de variable compleja">
...
<Definition title="Función real de variable compleja">
...
<Definition title="Función compleja de variable compleja">
...
<Theorem title="Función real de variable compleja" label="Ejemplo">
...
<Theorem title="Función compleja de variable real" label="Ejemplo">
...
<Theorem title="Función compleja de variable compleja" label="Ejemplo">
