...
<Theorem title="Derivabilidad implica continuidad">
...
<Theorem title="Linealidad de la derivada">
...
<Theorem title="Regla del producto (Leibniz)">
...
<Theorem title="Regla del cociente">
...
<Theorem title="Regla de la cadena">
...
<Theorem title="Derivada de la función inversa">
...
<Theorem title="Teorema de Fermat">
...
<Theorem title="Teorema de Rolle">
...
<Theorem title="Teorema del Valor Medio (Lagrange)">
...
<Theorem title="Teorema de Cauchy (valor medio generalizado)">
...
<Theorem title="Derivada nula implica función constante">
...
<Theorem title="Funciones con igual derivada difieren en una constante" label="Corolario">
...
<Definition title="Derivada y monotonía" label="Proposición">
...
<Theorem title="Regla de L'Hôpital (caso 0/0)">
...
<Theorem title="Regla de L'Hôpital (caso ∞/∞)">
